...
# Y_tem = Y.copy(deep=True) # I can't remember but Peipei may have added this after in her version of this code
# Y_tem.index = range(1,(Y.shape[0]+1)) # I don't know why she added the 2 classes either.
# Y_tem['Class'] = 0
Y['Class'] = 1
...
for train_index, test_index in Tr_te.split(Y.loc[:,trait],Y.Class):
	if nn == 0:
		...
		nn = 1
	# train_ID = Y.iloc[train_index] # these were for testing purposes
	# print(train_ID.shape)
	# print(train_ID.head())
	# test_ID = Y.iloc[test_index]
	# print(test_ID.shape)
	# print(test_ID.head())
	# print(test_ID[test_ID.Class==1].index.to_list())
