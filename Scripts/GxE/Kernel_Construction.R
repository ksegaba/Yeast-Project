# Montesinos-López, A., Montesinos-López, O.A., Montesinos-López, J.C. et al. 
# A guide for kernel generalized regression methods for genomic-enabled prediction. 
# Heredity 126, 577–596 (2021). https://doi.org/10.1038/s41437-021-00412-1

# Code for computing the linear, polynomial, sigmoid, Gaussian, AK1, AKL, 
# and exponential kernels
