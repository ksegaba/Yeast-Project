#!/mnt/ufs18/home-056/seguraab/tf-1.13.1-env/bin/python
# Description: genetic (sequential) neural network
...
class GeneticNeuralNetwork(Sequential):
    ...
    def __init__(self, child_weights=None):
        ...
        if child_weights is None:
            ...
            layer1 = Dense(10000, input_shape=(10000,), activation='sigmoid')
            layer2 = Dense(7000, activation='sigmoid')
            layer3 = Dense(4000, activation='sigmoid')
            layer4 = Dense(1000,  activation='sigmoid')
...
# Create Vector of Independent Variable
X = geno.iloc[:,0:10000]
