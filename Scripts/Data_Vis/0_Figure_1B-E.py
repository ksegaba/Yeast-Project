...
pheno.merge(clades, left_index=True, right_on="Standardized name").groupby("Clades").describe().to_csv("Scripts/Data_Vis/Section_1/pheno_clades_stats.csv")
